        ...
        <div>
          <ul style={{ listStyle: 'none', padding: 0 }}>
            <li style={{ marginBottom: "10px" }}>
              <Link to="/dashboard-clinicstaff" state={{ userRole: "ClinicStaff" }} style={{ textDecoration: "none", color: "#C7A76C", fontWeight: "bold" }}>
                Dashboard
              </Link>
            </li>

            <li style={{ marginBottom: '10px' }}>
              <Link to="/patient-record" state={{ userRole: "ClinicStaff" }} style={{ textDecoration: 'none', color: '#333' }}>
                Patient Record
              </Link>
            </li>

            <li style={{ marginBottom: '10px' }}>
              <Link to="/inventory" state={{ userRole: "ClinicStaff" }} style={{ textDecoration: 'none', color: '#333' }} >
                Inventory
              </Link>
            </li>

            <li style={{ marginBottom: '10px' }}>
              <Link to="/analytics" state={{ userRole: "ClinicStaff" }} style={{ textDecoration: 'none', color: '#333' }}>
                Analytics
              </Link>
            </li>
            <li style={{ marginBottom: "10px" }}>
              <Link to="/settings-personnel" state={{ userRole: "ClinicStaff" }} style={{ textDecoration: "none", color: "#333" }}>
                Settings
              </Link>
            </li>
          </ul>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
            ...
            <Link to="/manage-appointment" state={{ userRole: "ClinicStaff" }}>
              <button
                style={{
                  background: "#007BFF",
                  color: "white",
